...
CLONE_DATABASE_URI = environ.get('CLONE_DATABASE_URI', "mongodb+srv://bot:bot@cluster0.eqvky.mongodb.net/?retryWrites=true&w=majority") # Necessary If clone mode is true
